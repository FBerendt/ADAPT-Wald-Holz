...
import PublicationsData from "../../blocks/PublicationsData";
import PublicationsBlockes from "./PublicationsBlockes";
            ...
            className={`${
              index % 2 === 0
                ...
                ${
                  ...
                  index === PublicationsData.length - 2
                    ? "border-b-0"
                    : ""
                }
                `}
          >
            <PublicationsBlockes data={e} index={index} />
          </div>
        ))}
      </Box>
      <Footer />
